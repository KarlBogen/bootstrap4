...
class bs4_checkifnewproduct {  //Important same name as filename
    ...
    function translate() {
        switch ($_SESSION['language_code']) {
          case 'de':
            $this->description = '<strong>Dieses Modul geh&ouml;rt zum Systemmodul "BS4 Template Manager"</strong><br />Es wird automatisch konfiguriert mit dem Systemmodul.<br /><br /><strong>Dieses Modul ermittelt Daten f&uuml;r Awids Rating Breakdown ist und erweitert das Produkt-Array.</strong>';
            break;
          default:
            $this->description = '<strong>This module is part of the systemmodule "BS4 Template Manager"</strong><br />It is automatically configured with the system module.<br /><br /><strong>this module collects data for Awids Rating Breakdown and extend the products array.</strong>';
            break;
        }
    }
