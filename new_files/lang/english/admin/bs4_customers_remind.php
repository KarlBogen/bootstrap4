...
define('HEADING_TITLE', 'Customer remind when articles arrive again<br /><small>(this module is integrated into the Bootstrap 4 Template Manager)</small>');
...
define('TABLE_HEADING_PRODUCT_BILD' , 'Products Image');
define('TABLE_HEADING_PRODUCT_ST' , 'Pieces');
define('TABLE_HEADING_PRODUCT_DAT' , 'Products Model Edit');
define('TABLE_HEADING_PRODUCT_CUPO' , 'E-Mail / Gift');
define('TABLE_HEADING_DEL', 'Delete Entry?');
define('KD_REG', 'Registered Customer [Customer No.]');
